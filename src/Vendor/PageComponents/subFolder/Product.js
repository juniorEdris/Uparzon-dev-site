            ...
            <div className={`product-item ${product.isGrid && 'mb-30'}`} id={product.id}>
                  <div className="product-thumb">
                    ...
                    <div className="action-links">
                      <Link to="#" title="Edit details" onClick={()=> addToWishList()}><i className="lnr lnr-heart" /></Link>
                      <Link to="#" title="Mark as sold" onClick={()=>addToCompare()}><i className="lnr lnr-sync" /></Link>
                      <Link to="#" title="Quick view" onClick={()=>quickView()} data-target="#quickk_view" data-toggle="modal"><i className="lnr lnr-magnifier" /></Link>
                    </div> 
                  </div>
                  <div className="product-caption">
                    ...
                    <button className="btn-cart" onClick={(e)=> addToCart()} type="button">Mark as out of Stock</button>
                  </div>
